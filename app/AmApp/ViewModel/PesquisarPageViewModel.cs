        ...
        public PesquisarPageViewModel()
        {
            ...
            PesquisarClickedCommand = new Command(() => {
                try
                {
                    ...
                    var mensagem = "";
                    if (resultadoPesquisa.PESQUISA_STATUS.Equals("200"))
                    {
                        MessagingCenter.Send<PesquisaStatus>(resultadoPesquisa, "PesquisaRelatorioAbrir");

                    }
                    else
                    {
                        mensagem = "Pesquisa em andamento";
